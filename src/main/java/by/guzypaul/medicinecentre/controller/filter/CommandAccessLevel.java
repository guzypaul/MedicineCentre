...
public enum CommandAccessLevel {
    ...
    MODERATOR(Arrays.asList(LOGOUT, PROFILE_PAGE, CLIENT_LIST, CHANGE_APPOINTMENT_PAGE, CHANGE_APPOINTMENT,
            DELETE_APPOINTMENT, CHANGE_USER, DELETE_USER)),
    ADMIN(Arrays.asList(LOGOUT, PROFILE_PAGE, CLIENT_LIST, CHANGE_APPOINTMENT_PAGE, CHANGE_APPOINTMENT,
            DELETE_APPOINTMENT, CHANGE_USER, DELETE_USER)),
