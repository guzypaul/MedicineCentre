...
public enum CommandAccessLevel {
    ...
    USER(Arrays.asList(LOGOUT, PROFILE_PAGE, CHANGE_USER_PAGE, CHANGE_USER, CREATE_APPOINTMENT_PAGE, CREATE_APPOINTMENT)),
    ...
    ADMIN(Arrays.asList(LOGOUT, PROFILE_PAGE, USER_LIST,
            CHANGE_APPOINTMENT_PAGE, CHANGE_APPOINTMENT, DELETE_APPOINTMENT_PAGE, DELETE_APPOINTMENT,
