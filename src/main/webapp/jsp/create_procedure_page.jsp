            ...
            <form class="registration-inputs" action="${createProcedure}" method="post" enctype="multipart/form-data">
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <input id="price" class="form-control" tabindex="3" placeholder="<fmt:message key="price"/>" type="text" name="price"/>
                    </div>
                    <br>
                    <div>
                        <label for="description"><fmt:message key="description"/></label>
                        <input id="description" class="form-control" tabindex="4" placeholder="<fmt:message key="description"/>" type="text" name="description"/>
                    </div>
                    <br>
                    <div>
                        <label for="duration"><fmt:message key="duration"/> (<fmt:message key="minutes"/>)</label>
                        <input id="duration" class="form-control" tabindex="5" placeholder="<fmt:message key="minutes"/>" type="text" name="duration"/>
                    </div>
                    <br>
                    <div>
